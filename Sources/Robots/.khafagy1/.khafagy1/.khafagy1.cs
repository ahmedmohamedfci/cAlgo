...
namespace cAlgo.Robots
{
    ...
    public class MartingaleRobot : Robot
    {
        ...
        private TradeType GetRandomTradeType()
        {
            ...
            if (((cci.Result.Last(1) < -100) && (cci.Result.Last(2) < -100)) && (MarketSeries.TickVolume.Last(1) < (MarketSeries.TickVolume.Last(2))))
            {
            ...
            else if (((cci.Result.Last(1) > 100) && (cci.Result.Last(2) > 100)) && (MarketSeries.TickVolume.Last(1) < (MarketSeries.TickVolume.Last(2))))
            {
