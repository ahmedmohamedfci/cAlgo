...
namespace cAlgo.Robots
{
    ...
    public class collectiveIndicators_botneverlose : Robot
    {
        ...
        private void Open(TradeType tradeType)
        {
            ...
            if (position == null)
                ExecuteMarketOrder(tradeType, Symbol, 100000, "SampleRSI");
        }
        ...
        private void manageOpendPositions()
        {
            ...
            if (Account.Balance < Account.Equity && Positions.Count == 1)
            {
                ...
                if (Positions[0].TradeType == TradeType.Buy)
                {
                    ...
                    {
                        ModifyPosition(Positions[0], Symbol.Ask - (10 * pipValue), Symbol.Ask + (10 * pipValue));
                    }
                }
                else
                {
